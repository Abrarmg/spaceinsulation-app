...
export const LoginAdmin: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Role check is handled by ProtectedRoute.tsx
          ...
          <div className="p-6 md:p-8 space-y-5">
            ...
            {!showForgot ? (
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative flex items-center">
                    ...
                    <input
                      ...
                      placeholder="admin@spaceinsulation.com"
                ...
                {/* Toggle to worker portal */}
                <div className="text-center">
                  <span className="text-[10px] text-[#A7AFBD]/50 font-medium">Field Technician?</span>{' '}
                  <Link
                    to="/login/worker"
                    className="text-[10px] font-bold text-[#76C442] hover:underline cursor-pointer ml-1 inline-flex items-center gap-0.5"
                  >
                    <span>Use Worker Login Portal</span>
                    <span>&rarr;</span>
                  </Link>
                </div>
              </form>
